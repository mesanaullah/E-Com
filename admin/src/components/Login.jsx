...
const Login = ({ setToken }) => {
    ...
    return (
        <div className='min-h-screen flex items-center justify-center w-full'>
            <div className='bg-white shadow-md rounded-lg px-8 py-6 min-w-md'>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    <button className='bg-black text-white w-full mt-2 px-4 py-2 cursor-pointer active:bg-gray-700 rounded-sm' type='submit'>Login</button>
                </form>
            </div>
